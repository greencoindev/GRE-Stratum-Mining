...
USE_COINDAEMON_DIFF = False   # Set the maximum difficulty to the litecoin difficulty. SET TO FALSE SOME SORT OF BUG MAKES DIFFICULTY REALLY LOW
DIFF_UPDATE_FREQUENCY = 60 # Update the difficulty every minute
VDIFF_MIN_TARGET = 1                #  Minimum Target difficulty
VDIFF_MAX_TARGET = 1000000                # Maximum Target difficulty
